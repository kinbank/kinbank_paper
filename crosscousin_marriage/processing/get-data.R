...
x = assert_that(sum(taxa$in_dplace) == 154, msg = "There should be 154 Bantu taxa in D-PLACE. Something has changed!")
...
x = assert_that(sum(!is.na(taxa$EA023)) == 87, msg = "Data from EA023 does not equal 87. Something has changed!")
x = assert_that(sum(!is.na(taxa$EA025)) == 87, msg = "Data from EA025 does not equal 87. Something has changed!")
...
x = assert_that(sum(taxa$in_kinbank & !is.na(taxa$EA023)) == 74, msg = "Data in tree & in dplace does not equal 74. Something has changed!")
